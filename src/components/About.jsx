        ...
        <div className="p-10">
          ...
          <div className="flex justify-center ">
            <p className="text-[#33363B] text-center py-10">
              ...
              immersive
              <br />
              aspect of the real environment. In this way, augmented reality
              alters on s ongoing perception of a real-world environment,
              whereas virtual reality completely replaces the use s real-world
